    ...
    <div class="flex">
        ...
        <aside id="sidebar" class="w-64 bg-gray-800 text-white min-h-screen transition-transform duration-300">
            ...
            <nav class="text-sm">
                ...
                <a class="block py-2.5 px-4 hover:bg-gray-700 flex items-center" href="new/admin/user_account.php">
                    <i class="fas fa-plus mr-2"></i> Add Record
                </a>
                <a class="block py-2.5 px-4 hover:bg-gray-700 flex items-center" href="new/admin/Visulation.php">
